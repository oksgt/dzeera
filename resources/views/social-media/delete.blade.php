...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-md-0">
            ...
            <h2 class="h4 text-danger">Delete category "{{$socialMedia->social_media}}" "</h2>
            <p class="mb-0">Delete social media confirmation</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                            <!-- Form -->
                            <form action="{{ route('social-media.remove', ['socialMedia' => $socialMedia->id]) }}" method="post">
                                @csrf
                                @method('delete')
                                <div class="mb-0 p-1">
