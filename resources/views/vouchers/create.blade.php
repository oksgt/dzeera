...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-md-0">
            ...
            <h2 class="h4">Add New Voucher</h2>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <form action="{{ route('vouchers.store') }}" method="post">
                                ...
                                <div class="mb-0 p-1">
                                    ...
                                    id="voucher_name" name="voucher_name" aria-describedby="voucher_nameHelp">
                                    @error('voucher_name')
                                ...
                                <div class="mb-0 p-1">
                                    ...
                                    value="{{ old('code') }}"
                                    id="code" name="code" aria-describedby="codeHelp">
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
