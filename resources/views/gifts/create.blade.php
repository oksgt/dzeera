        ...
        <div class="d-block mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('gifts.create') }}">Create</a></li>
                </ol>
            </nav>
            <h2 class="h4">Add New Gift</h2>
                        ...
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <form action="{{ route('gifts.store') }}" method="post">
                                ...
                                <div class="mb-0 p-1">
                                    ...
                                    id="product_id" name="product_id" aria-label="Default select example">
                                ...
                                <div class="mb-0 p-1">
                                    ...
                                    <input type="text" class="form-control @error('gift_description') is-invalid @enderror"
                                    value="{{ old('gift_description') }}"
                                    id="gift_description" name="gift_description" aria-describedby="gift_descriptionHelp">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="mb-0 p-1">
                                ...
                                <select class="form-select @error('is_for_first_purchase') is-invalid @enderror"
                                    id="is_for_first_purchase" name="is_for_first_purchase" aria-label="Default select example">
                            ...
                            <div class="mb-0 p-1">
                                ...
                                <input type="text" class="form-control input-number-only @error('min_purchase_value') is-invalid @enderror"
                                value="{{ old('min_purchase_value') }}"
                    ...
                    $.ajax({
                        ...
                        success: function(options) {
                            ...
                            $.each(options, function(key, value) {
                                $('#product_opt_id').append('<option value="' + value.id + '">'+value.color_name+' size ' + value.size + '</option>');
                            });
                        }
                    });
                } else {
