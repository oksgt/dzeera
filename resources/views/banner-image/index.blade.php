...
@section('content')
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('bannerImage.index') }}">Home Banner</a></li>
                    </li>
                </ol>
            </nav>
            <h2 class="h4">Home Banner Images</h2>
        </div>
    </div>
    ...
    <div class="card card-body border-0 shadow table-wrapper ">
        ...
        <div class="col-12 mb-4">
            <form action="{{ route('bannerImage.upload') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="mb-3">
        ...
        <div class="row">
            @foreach ($BannerImage as $row)
                <div class="col-3">
                    <div class="card" >
                        <form action="{{ route('bannerImage.delete') }}" method="post">
                            @csrf
                            @method('post')
                        ...
                        <div style="height: 200px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                            <img src="<?= asset('banner/'.$row->file_name) ?>" class="card-img-top"
