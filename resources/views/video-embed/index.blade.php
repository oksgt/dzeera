...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Video Embedded</h2>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('video-embedded.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <div class="card card-body border-0 shadow table-wrapper ">
        <div class="card-header border-0 d-flex flex-column flex-lg-row align-items-center justify-content-start">
            <div class="mb-0">
                <form action="{{ route('video-embedded.index') }}" method="GET">
            ...
            <table class="table table-hover table-auto">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">
                            <a href="{{ route('video-embedded.index', ['sort' => 'url', 'dir' => ($column == 'url' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                                URL {!! ($column == 'url') ? '<i class="fas fa-sort-' . (($direction == 'asc') ? 'up' : 'down') . '"></i>' : '' !!}
                            </a>
                        </th>
                        <th class="border-gray-200">
                            <a href="{{ route('video-embedded.index', ['sort' => 'is_active', 'dir' => ($column == 'is_active' && $direction == 'asc') ? 'desc' : 'asc']) }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-sm btn-primary d-inline-flex align-items-center"
                                    href="{{ route('video-embedded.detail', ['videoEmbed' => $row]) }}">
                                    Edit
                                </a>
                                <a type="button" class="btn btn-sm btn-secondary d-inline-flex align-items-center"
                                    href="{{ route('video-embedded.delete', ['videoEmbed' => $row]) }}">
                                    Delete
                                </a>
                            </td>
                        </tr>
