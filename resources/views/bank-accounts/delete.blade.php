...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-md-0">
            ...
            <h2 class="h4 text-danger">Delete bank account "{{$bankAccount->bank_name}}"</h2>
            <p class="mb-0">Delete bank account confirmation</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                            <!-- Form -->
                            <form action="{{ route('bank-accounts.destroy', ['bankAccount' => $bankAccount]) }}" method="post">
                                @csrf
                                @method('delete')
                                <div class="mb-0 p-1">
