...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-md-0">
            ...
            <h2 class="h4">Add New Bank Account</h2>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <form action="{{ route('bank-accounts.store') }}" method="post">
                                ...
                                <div class="mb-0 p-1">
                                    ...
                                    value="{{ old('bank_name') }}"
                                    id="bank_name" name="bank_name" aria-describedby="bank_nameHelp">
                                    @error('bank_name')
                                ...
                                <div class="mb-0 p-1">
                                    ...
                                    id="account_name" name="account_name" aria-describedby="account_nameHelp">
                                    @error('account_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-0 p-1">
                                    ...
                                    id="account_number" name="account_number" aria-describedby="account_numberHelp">
