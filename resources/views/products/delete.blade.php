        ...
        <div class="d-block mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('category.index') }}">Products</a></li>
                </ol>
            </nav>
            <h2 class="h4 text-danger">Delete product "{{$product->product_name}}" </h2>
            <p class="mb-0">Delete product confirmation</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                            <!-- Form -->
                            <form action="{{ route('product.remove', ['product' => $product->id]) }}" method="post">
                                @csrf
                                @method('delete')
                                <div class="mb-0 p-1">
