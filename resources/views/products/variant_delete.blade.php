        ...
        <div class="d-block mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('product.detail', ['product' => $ProductOption->product_id]) }}">Detail</a>
                    <li class="breadcrumb-item"><a
                            href="{{ route('product.variant', ['product' => $ProductOption->product_id]) }}">Variant</a>
                    </li>
                    <li class="breadcrumb-item"><a
                        href="#">Edit Variant</a>
                    </li>
            ...
            <h2 class="h4 text-danger">Delete Variant "{{$ProductOption->color_name}}" size "{{$ProductOption->size}}"</h2>
            <p class="mb-0">From product {{ $ProductOption->product_name }}</p>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-lg-4 col-sm-6">
                            <!-- Form -->
                            <form action="{{ route('product.variant.remove') }}" method="post">
                                @csrf
